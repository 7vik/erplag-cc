    ...
    if (root != NULL)
    {
        ...
        switch(rule_num)
        {
            ...
            case(51):
            {
                ...
                list_id->tree_node =  root->kids[6]->data;
...
int main(int argc, char* argv[])          // driver
{
    ...
    printf("Ast nodes: %d, Parse nodes: %d\n, Compression ratio: %.3f\n", num_ast_nodes,num_parse_nodes, (((float)(num_ast_nodes))/num_parse_nodes));
    print_ast(ast_root);
    fclose(test_fp);
